...
async function register() {
  try {
    ...
    registerMessage.value = error.message.substring(
...
<template>
  ...
  <div id="registerPage">
    ...
    <button class="w-100 btn btn-lg btn-success" style="margin-top: 5px" @click="register()">
      Register
    </button>
