...
<template>
  <div class="onPage" id="loginPage">
    ...
    <template v-if="!user">
      ...
      <label>Email</label>
      <input class="form-control" v-model="email" type="email" placeholder="eg. some.fancy@email.com"
        :rules="validateEmail" />

      <label>Password</label>
      <input class="form-control" id="loginPassword" v-model="password" type="password" placeholder="Password"
